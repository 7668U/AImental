...
const PRODUCT_PRESENTATION = {
  vip_light: {
    type: 'membership',
    name: '轻语会员',
    icon: 'https://assets.feelyourself.cn/miniprogram/assets/releases/20260718-1/images/vip/plan-light.png',
    detail: '30 天',
  },
  vip_knowing: {
    type: 'membership',
    name: '相知会员',
    icon: 'https://assets.feelyourself.cn/miniprogram/assets/releases/20260718-1/images/vip/plan-knowing.png',
    detail: '30 天',
  },
  vip_companion: {
    type: 'membership',
    name: '长伴会员',
    icon: 'https://assets.feelyourself.cn/miniprogram/assets/releases/20260718-1/images/vip/plan-companion.png',
    detail: '30 天',
  },
  addon_tree_500: {
    type: 'addon',
...
function normalizeOrder(order) {
  ...
  return {
    id: order.id,
    type,
    icon: presentation.icon || 'https://assets.feelyourself.cn/miniprogram/assets/releases/20260718-1/images/vip/plan-knowing.png',
